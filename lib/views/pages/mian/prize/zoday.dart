...
class Zoday extends StatefulWidget {
  @override
  _ZodayState createState() => _ZodayState();
}

class _ZodayState extends State<Zoday> {
  Future _future;
  ...
  Widget _itemView(RankModel model) => Container(
            ...
            Expanded(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                      I18n.of(context)
                          .$t('prizeGeted', params: {'num': model.reward}),
                      style: model.rank == 1
