...
class FadeImg extends StatefulWidget {
  ...
  FadeImg.memoryNetwork({
    ...
    this.sdcache = false,
        ...
        image = NetImage(image, scale: imageScale, sdCache: sdcache),
        super(key: key);
...
/// The phases a [FadeImg] goes through.
@visibleForTesting
...
class _ImageProviderResolver {
  ...
  FadeImg get widget => state.widget;
  ...
  void resolve(ImageProvider provider) {
    ...
    if (_imageStream.key != oldImageStream?.key) {
      oldImageStream?.removeListener(_getListener());
...
class _FadeInImageState extends State<FadeImg> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(FadeImg oldWidget) {
